...
public class ArticleTest extends AppCompatActivity {
        ...
        aans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentQuestions < questionsItems.size() - 1) {
                    ...
                    Intent intent = new Intent(ArticleTest.this, ResultActivity.class);
    ...
    private void loadAllQuestions() {
        ...
        String jsonquiz = loadJsonFromAsset("articlequestions.json");
        try {
            JSONObject jsonObject = new JSONObject(jsonquiz);
            JSONArray questions = jsonObject.getJSONArray("articlequestions");
    ...
    public void onBackPressed() {
        ...
        MaterialAlertDialogBuilder materialAlertDialogBuilder = new MaterialAlertDialogBuilder(ArticleTest.this);
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                startActivity(new Intent(ArticleTest.this, MainActivity.class));
                finish();
            }
        });
